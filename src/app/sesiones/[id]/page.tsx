        ...
        <div className="print-page">
          ...
          <table className="session-table">
            <tbody>
              <tr>
                <td style={{width: '30%'}}>
                    <p><strong>Equipo:</strong> {session.equipo}</p>
                    <p><strong>Instalación:</strong> {session.instalacion}</p>
                    <p><strong>Microciclo:</strong> {session.microciclo}</p>
                    <p><strong>Nº Sesión:</strong> {session.sesion}</p>
                </td>
                <td style={{width: '70%'}}>
